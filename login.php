            ...
            <div class="main__form">
                ...
                <form action="login_core.php" method="GET">
                    <div class="form-row">
                        ...
                        <div class="col col-12">
                            <label class="input">
                                ...
                                <select name="role" id="Role">
                                    ...
                                    <option value="managers">Quảng lý</option>
                                    <option value="pharmacists">Dược sĩ</option>
                                    <option value="salesmans">Nhân viên sale</option>
                                </select>
                            </label>
                        </div>
                        ...
                        <a href="checkmk.php">Quên mật khẩu?</a>
                        </div>
                    </div>
                </form>
            </div>
